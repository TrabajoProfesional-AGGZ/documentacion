...
\begin{itemize}
    ...
    \item \textbf{Página publicitaria (Landing Page):} Pilar fundamental para nuestra imagen como marca, se desarrolló e implementó una web comercial oficial con dominio propio, diseñada para la captación y conversión de clientes (\url{https://www.sociounido.com/}).
\end{itemize}
