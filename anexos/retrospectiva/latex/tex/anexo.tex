...
\begin{itemize}
    ...
    \item \textbf{Página publicitaria (Landing Page):} Pilar fundamental para nuestra imagen como marca, se desarrolló e implementó una web comercial oficial con dominio propio, diseñada para la captación y conversión de clientes (\url{\textcolor{blue}{URL A CONFIRMAR}}).
\end{itemize}
...
\subsubsection*{Detalle de los repositorios privados}
\begin{itemize}
...
Dentro de estos repositorios reside no solo el código, sino también su propia página documental (JustTheDocs) que además de tener los mismos apartados que las anteriores. También expone algunas vistas principales del sistema.
\begin{itemize}
...
En estos repositorios se almacena integramente información documental relacionada a la totalidad del desarrollo del Trabajo Profesional.
\begin{itemize}
...
\begin{itemize}
    ...
    \item Desarrollo de la identidad visual: Marca, logotipos, íconos (\textit{marca blanca} y simulaciones).
    \item Diagramas del Modelo C4 (arquitectura de sistemas) y diagramas DER (capa de datos).
    \item Más de \textbf{25 anexos} formales analizando múltiples aristas técnicas, legales y de gestión.
