...
\subsubsection{Diseño base de 'SocioUnido': La maqueta neutral y el lienzo institucional}
...
\subsubsection{Entorno adaptativo: Inserción de la identidad deportiva}
...
Para ejemplificar en esta sección, se han seleccionado los siguientes tres clubes: \textbf{Boca Juniors}, \textbf{San Lorenzo de Almagro} y \textbf{Talleres de Remedios de Escalada}. Cada uno de estos casos se ha analizado desde la perspectiva de la Teoría del Color y las leyes de la Gestalt para justificar las decisiones de diseño propuestas.
