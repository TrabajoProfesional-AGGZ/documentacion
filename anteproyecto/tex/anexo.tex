...
\begin{itemize}
    ...
    \newline \textit{Solución:} Desarrollo de una plataforma web/móvil optimizada para datos en tiempo real mediante WebSockets, incorporando IA para generar resúmenes automáticos de las jornadas deportivas.
