...
* 🩺 **[HealthChecker](healthchecker/)**: Panel de monitoreo del estado y disponibilidad de los servicios en tiempo real.
* 💻 **[Plataforma web](plataforma-web/)**: Panel administrativo central orientado a la dirigencia y personal del club para la gestión integral.
* 📱 **[App del socio (PWA)](app-socio/)**: Aplicación web progresiva orientada al usuario final para gestión de perfil, carnet digital y reservas.
* 💼 **[App del empleado (PWA)](app-trabajadores/)**: Herramienta operativa para el personal del club, facilitando el seguimiento de tareas y control de accesos.
* 🤖 **[Bot conversacional](bot/)**: Flujos de interacción automatizada por WhatsApp impulsados por inteligencia artificial (NLP).
