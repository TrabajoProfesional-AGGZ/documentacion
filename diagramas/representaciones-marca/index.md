...
* **Logo SocioUnido (Oscuro)**
  <br><img src="logo-socio.png" alt="Logo Socio" width="250">
* **Logo SocioUnido (Claro)**
  <br><img src="logo-socio-alt.png" alt="Logo Socio Alt" width="250">
* **Ícono App SocioUnido**
  <br><img src="logo-app-socio.png" alt="Logo App Socio" width="150">
...
* **Reducción clara**
  <br><img src="logo-socio-alternativo-claro.png" alt="Reducción Clara" width="250">
* **Reducción oscura**
  <br><img src="logo-socio-alternativo-oscuro.png" alt="Reducción Oscura" width="250">
* **Header estándar**
  <br><img src="logo-socio-header.png" alt="Logo Header estándar" width="300">
...
* **Logo institucional**
  <br><img src="logo-socio-boc.png" alt="Logo BOC" width="250">
* **Ícono de App**
  <br><img src="logo-app-socio-boc.png" alt="Logo App BOC" width="150">

### Club Atlético Talleres (Remedios de Escalada)

* **Logo institucional** 
  <br><img src="logo-socio-RdE.png" alt="Logo RdE" width="250">
* **Ícono de App**
  <br><img src="logo-app-socio-RdE.png" alt="Logo App RdE" width="150">

### Club Atlético San Lorenzo de Almagro

* **Logo institucional**
  <br><img src="logo-socio-slo.png" alt="Logo SLO" width="250">
* **Ícono de App**
  <br><img src="logo-app-socio-slo.png" alt="Logo App SLO" width="150">
