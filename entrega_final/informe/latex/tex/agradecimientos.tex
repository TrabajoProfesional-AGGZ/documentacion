...
En primer lugar, queremos agradecer profundamente a nuestros tutores, el Mg. Ing. Gabriel Piñeiro y el Ing. Agustín Perrotta, por habernos guiado de manera incondicional durante todo el transcurso del desarrollo de este \textbf{Trabajo Profesional}. Gracias por su constante disposición, sus valiosas correcciones, y por todo lo que nos han enseñado y acompañado. Asimismo, les agradecemos por haber oficiado de orientadores en nuestro campo de desempeño, supervisando y avalando nuestra \textbf{Práctica Profesional Supervisada}. En esta misma línea, extendemos un agradecimiento especial a todos los involucrados en el desarrollo de dichas prácticas, por habernos respaldado y brindado el espacio necesario para llevarlas a cabo.
