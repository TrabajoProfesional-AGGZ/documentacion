...
\begin{itemize}
    ...
    \item \texttt{makefile-local}: Herramienta auxiliar para levantar el ecosistema completo de forma local.
\end{itemize}
...
\begin{itemize}
    \item \texttt{microservicio-club-doc}, \texttt{microservicio-pagos-doc}, \texttt{microservicio-autenticacion-doc}, \texttt{microservicio-acceso-doc}, \texttt{microservicio-analiticas-doc}, \\ \texttt{microservicio-bot-conversacional-doc} y \texttt{gateway-doc}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \texttt{healthchecker}: Monitor de disponibilidad global del ecosistema y de los clubes clientes (Este microservicio también tiene una funcionalidad vital en la \textbf{Arquitectura/Back-end} dentro del ecosistema, pero cuya implementación pública no expone detalles de implementación críticos que requieran cambiar la accesibilidad del repositorio).
\end{itemize}
