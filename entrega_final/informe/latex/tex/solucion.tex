...
\begin{figure}[h!]
    ...
    \vspace{0.8cm}
    \textbf{Inter Miami CF} \\ \vspace{0.2cm}
    \fbox{\includegraphics[width=0.9\textwidth]{img/plataforma-web/login-miami.jpeg}}
...
\begin{figure}[h!]
    ...
    \vspace{0.8cm}
    \textbf{Inter Miami CF} \\ \vspace{0.2cm}
    \fbox{\includegraphics[width=\textwidth]{img/plataforma-web/home-miami.jpeg}}
...
\begin{figure}[h!]
    ...
    \vspace{0.8cm}
    \textbf{Inter Miami CF} \\ \vspace{0.2cm}
    \fbox{\includegraphics[width=\textwidth]{img/plataforma-web/metricas-miami.jpeg}}
...
\begin{figure}[h!]
    \centering
    \textbf{Padrón general (Inter Miami CF)} \\ \vspace{0.2cm}
    \fbox{\includegraphics[width=\textwidth]{img/plataforma-web/socios-miami.jpeg}} \\
    \vspace{0.8cm}
    \textbf{Perfil de socio (Inter Miami CF)} \\ \vspace{0.2cm}
    \fbox{\includegraphics[width=\textwidth]{img/plataforma-web/socio-especifico-miami.jpeg}}
...
\begin{figure}[h!]
    \centering
    \textbf{Disciplinas general (Inter Miami CF)} \\ \vspace{0.2cm}
    \fbox{\includegraphics[width=\textwidth]{img/plataforma-web/disciplinas-miami.jpeg}} \\
    \vspace{0.8cm}
    \textbf{Tienda institucional (Inter Miami CF)} \\ \vspace{0.2cm}
    \fbox{\includegraphics[width=\textwidth]{img/plataforma-web/tienda-miami.jpeg}}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.28\textwidth}
        \centering
        \textbf{Marca blanca} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-socio/login-neutro.jpeg}}
    \end{minipage}\hspace{0.5cm}
    \begin{minipage}{0.28\textwidth}
        \centering
        \textbf{Inter Miami CF} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-socio/login-miami.jpeg}}
    \end{minipage}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.28\textwidth}
        \centering
        \textbf{Marca blanca} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-socio/home-neutro.jpeg}}
    \end{minipage}\hspace{0.5cm}
    \begin{minipage}{0.28\textwidth}
        \centering
        \textbf{Inter Miami CF} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-socio/home-miami.jpeg}}
    \end{minipage}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.3\textwidth}
        \centering
        \textbf{Perfil (Inter Miami CF)} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-socio/perfil-miami.jpeg}}
    \end{minipage}\hspace{0.5cm}
    \begin{minipage}{0.3\textwidth}
        \centering
        \textbf{Pagos (Inter Miami CF)} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-socio/pagos-miami.jpeg}}
    \end{minipage}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.3\textwidth}
        \centering
        \textbf{Marca blanca} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-socio/carnet-neutro.jpeg}}
    \end{minipage}\hspace{0.5cm}
    \begin{minipage}{0.3\textwidth}
        \centering
        \textbf{Inter Miami CF} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-socio/carnet-miami.jpeg}}
    \end{minipage}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.28\textwidth}
        \centering
        \textbf{Acceso (Inter Miami CF)} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-trabajadores/login-miami.jpeg}}
    \end{minipage}\hspace{0.5cm}
    \begin{minipage}{0.28\textwidth}
        \centering
        \textbf{Inicio (Inter Miami CF)} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-trabajadores/home-miami.jpeg}}
    \end{minipage}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.28\textwidth}
        \centering
        \textbf{Marca blanca} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-trabajadores/qr-neutro.jpeg}}
    \end{minipage}\hspace{0.5cm}
    \begin{minipage}{0.28\textwidth}
        \centering
        \textbf{Inter Miami CF} \\ \vspace{0.2cm}
        \fbox{\includegraphics[width=\textwidth]{img/app-trabajadores/qr-miami.jpeg}}
    \end{minipage}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=\textwidth]{img/arquitectura/c1_contexto.jpg}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=\textwidth]{img/arquitectura/c2_componentes.jpg}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=\textwidth]{img/arquitectura/diagrama.jpg}}
