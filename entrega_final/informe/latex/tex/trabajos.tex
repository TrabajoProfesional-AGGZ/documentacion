...
\noindent $\bullet$ \textbf{Desarrollo de aplicaciones móviles nativas (iOS y Android)}\\
Si bien la aplicación web progresiva (PWA) actual ofrece una adopción sin fricciones y multiplataforma, una evolución lógica del sistema sería el desarrollo de aplicaciones nativas. Esta implementación permitiría explotar al máximo las capacidades de \textit{hardware} de los teléfonos móviles, como la tecnología de comunicación de campo cercano (NFC). De este modo, los socios podrían validar su acceso físico simplemente acercando el dispositivo al molinete inteligente, de forma análoga a una tarjeta de transporte tradicional, agilizando el ingreso de manera exponencial en días de alta concurrencia.
