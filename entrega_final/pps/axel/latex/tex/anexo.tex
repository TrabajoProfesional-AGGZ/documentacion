...
\textbf{Zielonka, Axel}, DNI: 45.014.452, Padrón: 110310 \\
...
Las tareas asignadas consistieron en participar en el diseño y desarrollo de 'SocioUnido', una plataforma SaaS B2B orientada a modernizar la gestión administrativa, optimizar la recaudación y asegurar el control de accesos en clubes deportivos, asumiendo el rol de responsable de \textit{front-end}, experiencia/interfaz de usuario e imagen/marca. El trabajo del estudiante se destacó por la excelencia en el desarrollo del \textit{dashboard} web y la aplicación móvil (PWA), la creación de prototipos centrados en la usabilidad y su eficiente desempeño ejerciendo el rol de \textit{scrum master} del equipo.
