...
Las variantes de elevator pitch se han desarrollado para adaptarse a distintos contextos y objetivos, incluyendo presentaciones a inversores, académicos, clubes deportivos y contactos directos.

Cada variante está diseñada para resaltar los aspectos más relevantes de la plataforma SocioUnido según el público objetivo.

Además, todas las variantes fueron evolucionando a lo largo del tiempo, incorporando mejoras y ajustes basados en la retroalimentación recibida de las presentaciones previas.

\subsection{Variantes primitivas de elevator pitch}

En este apartado se detallan las primeras versiones de los elevator pitchs, que fueron refinadas posteriormente según el feedback recibido.
...
\subsection{Primera evolución de los elevator pitch}

\subsubsection{Variante 1: Enfoque comercial e inversores}

En la actualidad, los clubes deportivos sufren enormes fugas de capital por tres problemas operativos: morosidad no detectada, ingresos irregulares y espacios desaprovechados.
...
Logramos que el club vuelva a enfocarse en los socios, mientras nuestra tecnología asegura una administración impecable.

Hoy estamos buscando escalar nuestra solución a nivel regional, buscando aliados estratégicos para liderar juntos la transformación digital del deporte.

Dicho esto, me gustaría dejarles una pregunta: ¿les interesaría ver cómo nuestra herramienta cambia radicalmente los números de un club en sus primeros meses de uso?
...
Sabemos que los clubes entre las 5 primeras divisiones del fútbol argentino pierden millones de pesos anualmente debido a la morosidad y a la ineficiente gestión de sus espacios; el verdadero desafío de ingeniería detrás de esta transformación radica en la infraestructura: la alta concurrencia y los fallos de conectividad en las puertas de los estadios.

Para resolverlo, ya creamos un ecosistema digital —compuesto por un panel web y una app móvil— soportado íntegramente por una arquitectura de microservicios en la nube, lo que nos permite escalar de forma elástica e independiente ante picos de demanda.
...
Más allá de las demoras administrativas que alejan a los socios, hoy su club probablemente sufra pérdidas económicas por tres ineficiencias clave: la morosidad no detectada, los accesos irregulares en días de partido y los espacios subutilizados.

Soy [Nombre] y les presento SocioUnido: la plataforma que pone el club en el bolsillo del socio y el control financiero total en manos de la dirigencia.

Nuestra solución erradica la morosidad automatizando el cobro y seguimiento de pagos. Además, centralizamos la reserva de instalaciones para maximizar su ocupación, y blindamos sus accesos con nuestra tecnología de validación QR 100\% offline. Esto garantiza un ingreso masivo, rápido y antifraude, sin depender en absoluto de la conexión a internet.

Todo esto en un ecosistema muy intuitivo que no requiere comprar hardware costoso y es de adopción inmediata para todas las edades.

¿Les gustaría que evaluemos juntos cuánto capital podría recuperar su institución implementando nuestro sistema en los próximos meses?

\subsubsection{Variante 4: Enfoque networking y contacto directo}

Hola [Nombre del contacto], un gusto saludarte. Soy [Nombre] de SocioUnido.

Conociendo el día a día de las instituciones deportivas, sabemos que hoy la mayoría enfrenta fugas de dinero por tres motivos: morosidad acumulada, accesos no autorizados y espacios ociosos. 

Nosotros desarrollamos el sistema de digitalización que resuelve esto de raíz. Le entregamos a la administración un panel con métricas claras para recuperar socios deudores, y a los usuarios una app para pagos y reservas en segundos. Nuestro gran diferencial es que aseguramos las puertas del club con un control de accesos QR 100\% offline, que funciona a la perfección sin internet.

Lo mejor es que el sistema no requiere hardware adicional y su implementación es sumamente rápida.

Te dejo mi tarjeta. Me encantaría que nos tomemos un café la próxima semana para mostrarte con números cómo SocioUnido puede optimizar radicalmente la gestión en tu club.
...
\subsubsection{Axel Zielonka - Responsable de Front-end, Aplicación Móvil, Diseño UX/UI e Identidad de Marca}
...
\subsubsection{Martín Guerrero - Responsable de Inteligencia Artificial, Back-end y Relaciones Institucionales}
